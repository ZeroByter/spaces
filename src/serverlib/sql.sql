...
CREATE TABLE "postvotes" (
	...
	"timecreated" NUMERIC NOT NULL,
	PRIMARY KEY ("id"),
	CONSTRAINT "FK__posts" FOREIGN KEY ("postid") REFERENCES "comments" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
...
CREATE TABLE "commentvotes" (
	...
	CONSTRAINT "FK__posts" FOREIGN KEY ("commentid") REFERENCES "posts" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
	CONSTRAINT "FK__users" FOREIGN KEY ("userid") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
